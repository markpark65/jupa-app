...
var Timestamp = class Timestamp {
	...
	*/ static fromMillis(e) {
		...
		return new Timestamp(t, Math.floor((e - 1e3 * t) * $));
	}
	/**
...
var __PRIVATE_IndexBackfillerScheduler = class {
	...
	re(e) {
		__PRIVATE_logDebug(z, `Scheduled in ${e}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", e, (async () => {
			this.task = null;
			try {
				__PRIVATE_logDebug(z, `Documents written: ${await this.ne.ie()}`);
			} catch (e$1) {
...
*/ async function __PRIVATE_syncEngineRejectListen(e, t, n) {
	...
	if (s) {
		...
		await __PRIVATE_syncEngineApplyRemoteEvent(r, new RemoteEvent(SnapshotVersion.min(), /* @__PURE__ */ new Map(), new SortedMap(__PRIVATE_primitiveComparator), e$1, n$1)), r.du = r.du.remove(s), r.Au.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
